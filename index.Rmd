...
Both tracks are K-pop and belongs to joint-tracks, which refers to that two or more styles of music/chorus/verses are combined into one track. "O.O" and "Aespa" are the recent joint-tracks, where their structures are constructed by two or more verses. 
